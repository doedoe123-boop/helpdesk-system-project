...
if(isset($_POST['submit'])){
   ...
   if($inset){
        ...
        $mail->Port       = 587;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
         ...
         //Recipients
        $mail->setFrom('helpdesksupport@bcp-sis.ga', 'Ticket Mail');
        $mail->addAddress($_POST['email'], 'Student');     //Add a recipient
       
       $body = "Dear Student your tickets has been sent to our help desk support team and we will back to you shortly. and here is your ticket id $unid please keep your ticket id";
