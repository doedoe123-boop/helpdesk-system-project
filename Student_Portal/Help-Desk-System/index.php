...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="../includes/hd-image/mvcampus1.jpg" class="d-block w-100" alt="...">
    ...
    <div class="carousel-item">
      <img src="../includes/hd-image/mvcampus2.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h5>MV campus</h5>
        <p>Building.</p>
      </div>
    ...
    <div class="carousel-item">
      <img src="../includes/hd-image/mvcampus3.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block">
       <h5>MV campus</h5>
        <p>Building.</p>
      </div>
    ...
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      ...
      <div class="col-lg-6">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-start">
          <a href="about.php?id=<?php echo $_SESSION["login_key"];?>" class="<?php if($page=='page'){echo 'btn';}else{echo 'btn btn-outline-primary';}?>" >More info</a>
                    ...
                    <div class="list-boxs">
                        <div class="card starter">
                            ...
                            <div class="body">
                              ...
                              <a href="pages-faq.php?id=<?php echo $_SESSION["login_key"];?>" class="<?php if($page=='page'){echo 'btn';}else{echo 'btn btn-outline-primary';}?>" >Get Started</a>
                            </div>
                          </div>
                          <div class="card standard">
                            <div class="head">
                              ...
                              <div class="body">
                                ...
                                <a href="new_ticket.php?id=<?php echo $_SESSION["login_key"];?>" class="<?php if($page=='page'){echo 'btn';}else{echo 'btn btn-outline-primary';}?>" >Get Started</a>
                              </div>
                            </div>
